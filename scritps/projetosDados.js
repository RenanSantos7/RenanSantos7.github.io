const projetosDados = [
    {
        ...
        "descricao": "<p>Um projeto de <em>Vade Mecum</em>, o famoso compêndio de leis usados por estudantes e profissionais de Direito.</p><p>Tem navegação simples e utiliza conceitos de HTML5, CSS3 e JavaScript para criar uma experiência de usuário única, preocupada com a legibilidade e acessibilidade.</p><figure><img src='../assets/cf.png' alt='Vade Mecum Tela Lei'><figcaption>Constituição Federal</figcaption></figure><p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nihil, quo dicta. Totam, blanditiis. Magnam nihil ab quaerat facere corporis perferendis veritatis accusantium delectus? Libero consequuntur dicta necessitatibus molestias corrupti. Quod?</p><figure><img src='../assets/cc.png' alt='Código Civil Vade Mecum'><figcaption>Código Civil</figcaption></figure>"
    },
    
    {
        ...
        "alt": "Vade Mecum Tela Principal",
        "descricao": "<p>Um cardápio de pizzaria para ser usado com QRCode.</p><p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates, fuga. Assumenda accusamus et secum iure quidem, aliquid facilis corporis nostrum a deserunt ipsa, aliquam ea iusto natus nisi.</p>"
    },

    {
        ...
        "descricao": "<p>Uma calculadora simples usando conceitos moderos de CSS3 e JavaScript.</p><p>Os números estão dispostos em <code>CSS grid</code>, o que torna todo o código HTML mais simples e fácil de programar no JavaScript.</p><p>Executa operações de soma, multiplicação, divisão e subtração.</p>"
    },
