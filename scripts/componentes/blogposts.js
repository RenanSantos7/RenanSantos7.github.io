const posts = [
    {
        id: 0,
        titulo: 'Olá mundo',
        publicacao: '17/10/2023',
        tagList: ['geral', 'texto', 'teste'],
        img: 'https://images.unsplash.com/photo-1579600161224-cac5a2971069',
        descricao: 'Seguindo a velha regra da informática de que ao começar algo novo, se deve começar com essa mens...',
        conteudo: 
    ...
    
    {
        id: 0,
        titulo: 'Meu 2023',
        publicacao: '26/12/2023',
        tagList: ['geral'],
        img: './assets/blog/edge-vscode.jpg',
        descricao: 'Se algo marcou meu 2023, com certeza foram as mudanças. Tanto na vida pessoal quanto na profissional eu precisei me redescobrir.',
        conteudo: 
